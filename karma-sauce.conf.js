...
module.exports = function(config) {
	config.set({
		...
		files: [
			...
			// will be added first.
			{
				pattern: 'packages/metal-custom-element/node_modules/@webcomponents/custom-elements/src/*.js',
				watched: false,
				included: true,
				served: true
			},
		...
		preprocessors: {
			'packages/metal-custom-element/node_modules/@webcomponents/custom-elements/src/*.js': ['browserify'],
