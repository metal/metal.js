...
core.inherits(Attribute, EventEmitter);
 ...
 */
Attribute.prototype.addAttr = function(name, config, initialValue) {
 ...
 */
Attribute.prototype.addAttrs = function(configs, initialValues) {
 ...
 * @protected
 */
Attribute.prototype.addAttrsFromStaticHint_ = function(config) {
 ...
 * @throws {Error}
 */
Attribute.prototype.assertValidAttrName_ = function(name) {
  if (name === 'attrs') {
 ...
 * @protected
 */
Attribute.prototype.canWrite_ = function(name) {
  this.initAttr_(name);
 ...
 * @protected
 */
Attribute.prototype.callFunction_ = function(fn) {
 ...
 */
Attribute.prototype.callSetter_ = function(name, value) {
  var info = this.attrsInfo_[name];
 ...
 */
Attribute.prototype.callValidator_ = function(name, value) {
  var info = this.attrsInfo_[name];
  var config = info.config;
  if (config.validator) {
 ...
 */
Attribute.prototype.getAttrs = function() {
  var attrsMap = {};
 ...
 * @protected
 */
Attribute.prototype.getAttrValue_ = function(name) {
  this.initAttr_(name);
 ...
 * @protected
 */
Attribute.prototype.informChange_ = function(name, prevVal) {
 ...
 * @protected
 */
Attribute.prototype.initAttr_ = function(name) {
  var info = this.attrsInfo_[name];
 ...
 */
Attribute.prototype.mergeAttrs_ = function(values) {
 ...
 * @param {string} name The name of the attribute.
 */
Attribute.prototype.removeAttr = function(name) {
 ...
 * @protected
 */
Attribute.prototype.scheduleBatchEvent_ = function(attrChangeData) {
 ...
 *   should be set to.
 */
Attribute.prototype.setAttrs = function(values) {
 ...
 * @protected
 */
Attribute.prototype.setAttrValue_ = function(name, value) {
 ...
 * @return {*}
 */
Attribute.prototype.setDefaultValue_ = function(name) {
 ...
 * @return {*}
 */
Attribute.prototype.setInitialValue_ = function(name) {
  var info = this.attrsInfo_[name];
 ...
 * @return {Boolean}
 */
Attribute.prototype.shouldInformChange_ = function(name, prevVal) {
  var info = this.attrsInfo_[name];
 ...
 * @return {Boolean} Flag indicating if value is valid or not.
 */
Attribute.prototype.validateAttrValue_ = function(name, value) {
  var info = this.attrsInfo_[name];
