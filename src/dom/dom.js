 ...
 */
dom.buildFragment = function(htmlString) {
 ...
 */
dom.delegate = function(element, eventName, selector, callback) {
  return dom.on(
    element,
    eventName,
 ...
 * @protected
 */
dom.matchFallback_ = function(element, selector) {
 ...
 * @param {!Event} event
 */
dom.normalizeDelegateEvent_ = function(event) {
 ...
 * @return {!DomEventHandle} Can be used to remove the listener.
 */
dom.on = function(element, eventName, callback) {
 ...
 * @protected
 */
dom.stopImmediatePropagation_ = function() {
  this.stopped = true;
 ...
 * @return {boolean}
 */
dom.supportsEvent = function(element, eventName) {
 ...
 */
dom.toElement = function(selectorOrElement) {
 ...
 */
dom.triggerEvent = function(element, eventName, opt_eventObj) {
