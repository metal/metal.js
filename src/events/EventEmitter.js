...
core.inherits(EventEmitter, Disposable);
 ...
 */
EventEmitter.prototype.addListener = function(events, listener) {
 ...
 * @protected
 */
EventEmitter.prototype.addSingleListener_ = function(event, listener, opt_origin) {
 ...
 * @protected
 */
EventEmitter.prototype.compareListenerObjs_ = function(obj1, obj2) {
 ...
 * @override
 */
EventEmitter.prototype.disposeInternal = function() {
 ...
 * @return {string}
 */
EventEmitter.prototype.getDelimiter = function() {
 ...
 * @return {boolean}
 */
EventEmitter.prototype.getShouldUseFacade = function() {
 ...
 * @return {!EventHandle} Can be used to remove the listener.
 */
EventEmitter.prototype.many = function(events, amount, listener) {
  events = this.normalizeEvents_(events);
  for (var i = 0; i < events.length; i++) {
 ...
 * @protected
 */
EventEmitter.prototype.many_ = function(event, amount, listener) {
  var self = this;
 ...
 * @protected
 */
EventEmitter.prototype.matchesListener_ = function(listenerObj, listener) {
 ...
 * @protected
 */
EventEmitter.prototype.mergeListenerArrays_ = function(arr1, arr2) {
 ...
 * @protected
 */
EventEmitter.prototype.normalizeEvents_ = function(events) {
 ...
 * @return {!Object} Returns emitter, so calls can be chained.
 */
EventEmitter.prototype.removeAllListeners = function(opt_events) {
  if (!opt_events) {
 ...
 * @protected
 */
EventEmitter.prototype.removeAllListenersForEvents_ = function(events) {
  events = this.normalizeEvents_(events);
  for (var i = 0; i < events.length; i++) {
 ...
 * @protected
 */
EventEmitter.prototype.removeMatchingListenerObjs_ = function(listenerObjects, listener) {
 ...
 * @protected
 */
EventEmitter.prototype.searchListenerTree_ = function(events) {
  var values = [];
 ...
 * @return {!Object} Returns emitter, so calls can be chained.
 */
EventEmitter.prototype.setDelimiter = function(delimiter) {
 ...
 * @return {!Object} Returns emitter, so calls can be chained.
 */
EventEmitter.prototype.setShouldUseFacade = function(shouldUseFacade) {
 ...
 * @protected
 */
EventEmitter.prototype.splitNamespaces_ = function(event) {
 ...
 * @protected
 */
EventEmitter.prototype.validateListener_ = function(listener) {
