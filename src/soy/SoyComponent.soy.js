...
Templates.SoyComponent.component = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml('<div data-component="' + soy.$$escapeHtmlAttribute(opt_data.name) + '" data-ref="' + soy.$$escapeHtmlAttribute(opt_data.ref) + '">' + ((opt_ijData.renderChildComponents) ? soy.$$escapeHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId('ComponentElement'), opt_data.name, true)(opt_data.data, null, opt_ijData)) : '') + '</div>');
};
if (goog.DEBUG) {
